...
public class CouponUserReceiveAuto {
    private Long couponUserReceiveId;
    ...
    public Long getCouponUserReceiveId() {
        return couponUserReceiveId;
    }

    public void setCouponUserReceiveId(Long couponUserReceiveId) {
        this.couponUserReceiveId = couponUserReceiveId;
    }
