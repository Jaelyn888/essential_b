...
public class CouponUseScopeAuto {
    private Long couponUseScopeId;
    ...
    public Long getCouponUseScopeId() {
        return couponUseScopeId;
    }

    public void setCouponUseScopeId(Long couponUseScopeId) {
        this.couponUseScopeId = couponUseScopeId;
    }
