package com.essential.bussiness.rejectreason.model.auto;

public class RejectReasonAuto {
    ...
    public Long getRejectWorkId() {
        return rejectWorkId;
    }

    public void setRejectWorkId(Long rejectWorkId) {
        this.rejectWorkId = rejectWorkId;
    }
