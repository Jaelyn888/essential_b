$(document).ready(function () {
    ...
    var msie = navigator.userAgent.match(/msie/i); //浏览器内核标识,msie指ie内核
    $.browser = {};
    $.browser.msie = {};
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', ctxPath + '/charisma_ui_components/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', ctxPath + '/charisma_ui_components/css/bootstrap-' + themeName + '.min.css');
        }
    ...
    //establish history variables 建立历史变量
    var
    ...
    */
    ...
    $(document).on('click','.ajax-link', function (e) {
        ...
        $('.navbar-toggle').removeClass('active');
        $('#loading').remove();
        $('#content').fadeOut().parent().append('<div id="loading" class="center">加载中，请稍后...<div class="center"></div></div>');
        var $clink = $(this);
        $('ul.main-menu li.active').removeClass('active');
        $clink.parent('li').addClass('active');
        ...
        $.ajax({
            ...
            error: function(xhr, ajaxOptions, thrownError) {
            	$('#content').html('<h4>无法加载请求，请联系系统管理员！</h4>');
                $('#loading').remove();
                $('#content').fadeIn();
            }
        });
